...
import com.code.arctouch.arctouchcodechallenge.data.FakeUpcomingMoviesRemoteDataSource;
...
public class Injection {
    ...
    public static UpcomingMoviesRepository provideUpcomingMoviesRepository(@NonNull Context context) {
        ...
        return UpcomingMoviesRepository.getInstance(FakeUpcomingMoviesRemoteDataSource.getInstance(),
